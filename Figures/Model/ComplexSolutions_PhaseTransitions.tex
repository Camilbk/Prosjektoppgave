...
% coordinates
    ...
    \filldraw[black] (0.46,1.18) circle (0.6pt) node[anchor = south ]{$b$} ;
...
% coordinates
    ...
    \filldraw[black] (1.5,0.4) circle (0.6pt) node[anchor = north]{$c$};
     ...
     \draw[-][black!30] (0.22,1.09) -- (1.85,1.73) ;
     \draw[-][black!30] (0.14,0.5)  -- (1.5,0.4) ;
...
% coordinates
    ...
    \filldraw[black] (1.61,0.6) circle (0.6pt) node[anchor = north]{$u_l$};
     ...
     \draw[-][line width=0.3mm, lime] (0.18,0.92) -- (0.22,1.09); 
