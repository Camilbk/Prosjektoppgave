...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/RarefacAtTime2.png}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/RarefacAtTime5.png}
         %\caption{Solution $\rho(x,t)$ at time $t = 0.2$}
         %\label{fig:RarefacAtTime}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/RarefacAtTime8.png}
         %\caption{Solution $\rho(x,t)$ at time $t = 0.2$}
         %\label{fig:RarefacAtTime}
     \end{subfigure}
     \hfill
