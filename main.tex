...
%Even in everyday phenomena like traffic jams on heavily congested roads, we experience shock waves when there is an accumulation of cars. The shocks do not come from collisions of cars but rather from a rapid change in the density of cars.
...
\begin{comment}
\subsubsection{The Kružkov entropy}\label{The Kružkov entropy}
...
We can show that Theorem \ref{RP_Kružkov_sol} satisfies the Kružkov entropy condition \ref{Kružkov}. 
To complete the proof of \ref{RP_Kružkov_sol}, we need to show that \ref{ScalarRiemannSol} indeed satistfies the Kružkov entropy. 
...
Which concludes that the Riemann solution above indeed satisfies the Kružkov entropy if $u_l < u_r$.

It can also be shown that Theorem \ref{RP_Kružkov_sol} also holds for piecewise linear flux functions.
\end{comment}
...
%\end{equation*}
%which also satisfies the Kružkov entropy condition %\ref{Kružkov}. Furthermore, if $v_0$ is another %function in $BV \cap L^1(\mathbb{R}$, $g(v)$ is a %piecewise twice continously differentiable %function, and $v$ is the unique Kružkov entropy %solution to 
%\begin{equation*}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[t]{0.2\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/Sys1aAtTime4.png}
     \end{subfigure}
     \begin{subfigure}[t]{0.2\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/Sys1aAtTime7.png}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.35\textwidth}
         \centering
...
\end{figure} \begin{figure}[H]
     ...
     \begin{subfigure}[t]{0.2\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/Sys2aAtTime5.png}
     \end{subfigure}
     \begin{subfigure}[t]{0.2\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/Sys2aAtTime7.png}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.35\textwidth}
         \centering
     ...
     \end{subfigure}
        \caption{The evolution of a solution with initial values $u_l = (0.11, 0.56), u_r = (0.8, 0.9)$, seen to the top left. After $t = 0.7$, we have the top right figure. In the $(x,t)$-plane, we have bottom left for $\rho(x,t)$ and bottom right for $q(x,t)$. 
...
\begin{figure}[H]
     ...
     \begin{subfigure}[t]{0.2\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/Sys3bAtTime3.png}
     \end{subfigure}
     \begin{subfigure}[t]{0.2\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/Sys3bAtTime5.png}
     \end{subfigure}
     \begin{subfigure}[t]{0.2\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/Model/Plots/Sys3bAtTime7.png}
     \end{subfigure}
     \hfill 
     \begin{subfigure}[b]{0.35\textwidth}
         \centering
...
We continue with a few examples. Note that we have already shown case $(3)$ in example $3b)$ above. We will now demonstrate $(4)$ and $(6)$ as they are least similar to the examples already demonstrated above. 
