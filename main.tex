...
\begin{figure}[H]
     ...
     \end{subfigure}
        \caption{The evolution of a solution with initial values $\rho_l = 0.8, \rho_r = 0.2$, seen to the left. After $t = 0.2$, we have the middle figure. A full solution in the $x,t$-plane can be seen to the right.$R = 1, Q = 0.5$}
...
\end{figure} \begin{figure}[H]
     ...
     \end{subfigure}
        \caption{The evolution of a solution with initial values $\rho_l = 0.2, \rho_r = 0.9$, seen to the left. After $t = 0.5$, we have the middle figure. A full solution in the $x,t$-plane can be seen to the right. $R = 1, Q = 0.5$}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.35\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Figures/ModelSysContactsQ.png}
     \end{subfigure}
        \caption{The evolution of a solution with initial values $\rho_l = 0.2, \rho_r = 0.9$, seen to the left. After $t = 0.5$, we have the middle figure. A full solution in the $x,t$-plane can be seen to the right. $R = 1, Q = 0.5$}
        \label{fig:ExampleSysShock}
\end{figure}
