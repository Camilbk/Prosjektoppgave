...
\end{align*}
An example of a rarefaction wave solution for the Riemann problem can be seen in Figure \ref{fig:ExampleRarefaction}.
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         ...
         %\label{fig:five over x}
     \end{subfigure}
        \caption{The evolution of a solution with initial values $\rho_l = 0.2, \rho_r = 0.9$, seen to the left. After $t = 0.5$, we have the middle figure. A full solution in the $x,t$-plane can be seen to the right.}
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         ...
         %\label{fig:five over x}
     \end{subfigure}
        \caption{The evolution of a solution with initial values $\rho_l = 0.3, \rho_r = 0.6$, seen to the left. After $t = 0.5$, we have the middle figure. A full solution in the $x,t$-plane can be seen to the right.}
...
\begin{align*}
   ...
   & w_1(\xi; u_l, u_m) = \begin{pmatrix} \frac{R(2\rho_l \xi - q_l + Q) +Q \rho_l}{2(Q-q_l} \\  R/2 ( \frac{q_l - Q}{\rho_l} - \xi) + Q/2 \end{pmatrix} 
\end{align*}
